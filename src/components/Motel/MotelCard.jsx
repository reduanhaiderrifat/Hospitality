...
const MotelCard = ({ motel, index }) => {
  const { title, image, status, rating, segment_name, id } = motel;
  return (
    <div>
      <div
        data-aos={index % 2 == 0 ? "fade-down" : "fade-up"}
        data-aos-duration="1000"
        className="rounded-md shadow-md relative dark:bg-gray-50 dark:text-gray-800"
      >
        <img
          src={image}
          alt=""
...
MotelCard.propTypes = {
  motel: Proptypes.object.isRequired,
